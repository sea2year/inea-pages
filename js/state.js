...
const state = {
  ...
  drawingTool: 'select',
  interaction: {
    mode: 'idle',         // 'idle' | 'pan' | 'dragging-card' | 'dragging-group' | 'trimming-left' | 'trimming-right' | 'adjusting-volume' | 'connecting' | 'rubber-band' | 'dragging-line-endpoint' | 'dragging-line-body'
    targetCardId: null,
    targetGroupId: null,
    dragStart: { x: 0, y: 0 },
